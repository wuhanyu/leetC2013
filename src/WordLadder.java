...
/**
 * @author Simon
 * @see http://leetcode.com/onlinejudge#question_127
 ...
 *          characters.
 * 
 * @note It didn't pass with travel through the whole dict at first. Changed it
 *       to dict key test, then passed the large data.
 */
public class WordLadder {
	...
	public static void main(String[] args) {
		...
		String[] input = { "slit", "bunk", "wars", "ping", "viva", "wynn",
