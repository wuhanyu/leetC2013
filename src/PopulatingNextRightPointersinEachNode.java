...
/**
 * @author Simon@itechs
 * @see http://leetcode.com/onlinejudge#question_116
 * @problem Given a binary tree
 * 
 *          struct TreeLinkNode { TreeLinkNode *left; TreeLinkNode *right;
 *          TreeLinkNode *next; } Populate each next pointer to point to its
 ...
 *          parent has two children). For example, Given the following perfect
 *          binary tree,
 * 
 *          1 / \ 2 3 / \ / \ 4 5 6 7 After calling your function, the tree
 *          should look like:
 * 
