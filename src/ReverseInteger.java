...
/**
 * @author Simon
 * @see http://leetcode.com/onlinejudge#question_7
 ...
 *          an option? You would then have to re-design the function (ie, add an
 *          extra parameter).
 * 
 * @note Better to ask questions to specify the problem
 */
public class ReverseInteger {
	...
	public static void main(String[] args) {
		...
		System.out.println(new ReverseInteger().reverse(3240));
	}
